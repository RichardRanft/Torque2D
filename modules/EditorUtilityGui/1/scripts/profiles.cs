...
if (!isObject(GuiToolboxButtonProfile)) new GuiControlProfile (GuiToolboxButtonProfile : GuiEditorWindowProfile)
{
   justify = "center";
   fontColor = "0 0 0";
   border = 0;
...
if (!isObject(GuiDirectoryTreeProfile)) new GuiControlProfile (GuiDirectoryTreeProfile : GuiEditorTreeViewProfile)
{
   fontColor = "40 40 40";
